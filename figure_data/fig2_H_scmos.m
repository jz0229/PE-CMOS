%save('fig2_H_vid_scmos.mat','scmos_vid'); 
...
set(gcf,'position',[50,50,350,540])
cell_roi = roipoly;
...
for i=1:length(scmos_vid)
   tmp = -1*scmos_vid(:,:,i); %invert the time series
...
fullroi_noise = filtfilt(bpFilt_noise,-1*scmos_fullroi_raw(10:end-10));
