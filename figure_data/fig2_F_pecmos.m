...
load('./raw_data/fig2_F_vid.mat'); 
load('./raw_data/fig2_F_mask.mat'); 
...
figure(2); 
a = subplot(1,2,1); 
imagesc(sum_img(10:end,1:50), [130 289]); colormap(gray); 
title('Max. Project of the pCMOS video'); 
b = subplot(1,2,2); 
...
noise_range = (4300:5800);
Ph_total_noise_std = std(Ph_total_noise(noise_range))

total_range = [200:7000];

figure(5);
plot([1:length(Ph_total(total_range))]*1/800,Ph_total(total_range)); hold on; 
